...
public interface CartServiceInterface {
    ...
    CartDTO addProductToCart(Long cartId, Long productId, Long customerId, int count);

    CartDTO removeProductFromCart(Long cartId, Long productId, Long customerId, int count);
}
